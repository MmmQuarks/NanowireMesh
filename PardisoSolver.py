...
def solve(
	...
	'''
	Solve circuit using IntelMKL ParallelDirectSolver (Pardiso). Dangling ends and nodes that are not in the percolating cluster are treated as having undefined voltage.
	...
	# setting sheetResistance attribute 
...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(
		prog = 'PardisoSolver',
		description = 'Solve nanowire mesh with pardiso'
		)
	parser.add_argument(
		'path',
